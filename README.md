...
shell> cd ../
/Users/laghdafhacen/Documents/GitHub_PFE/RegularizedOptimization.jl

(@v1.11) pkg> activate .
  Activating project at `~/Documents/GitHub_PFE/RegularizedOptimization.jl`

(RegularizedOptimization) pkg> instantiate
Precompiling project...
  1 dependency successfully precompiled in 10 seconds. 132 already precompiled.

(RegularizedOptimization) pkg> dev ../ShiftedProximalOperators.jl/
   Resolving package versions...
    Updating `~/Documents/GitHub_PFE/RegularizedOptimization.jl/Project.toml`
  [d4fd37fa] ~ ShiftedProximalOperators v0.2.1 ⇒ v0.2.1 `../ShiftedProximalOperators.jl`
    Updating `~/Documents/GitHub_PFE/RegularizedOptimization.jl/Manifest.toml`
  [d4fd37fa] ~ ShiftedProximalOperators v0.2.1 ⇒ v0.2.1 `../ShiftedProximalOperators.jl`

(RegularizedOptimization) pkg> dev ../NLPModelsModifiers.jl/
   Resolving package versions...
    Updating `~/Documents/GitHub_PFE/RegularizedOptimization.jl/Project.toml`
  [e01155f1] ~ NLPModelsModifiers v0.7.2 ⇒ v0.7.2 `../NLPModelsModifiers.jl`
    Updating `~/Documents/GitHub_PFE/RegularizedOptimization.jl/Manifest.toml`
  [e01155f1] ~ NLPModelsModifiers v0.7.2 ⇒ v0.7.2 `../NLPModelsModifiers.jl`

(RegularizedOptimization) pkg> dev ../LinearOperators.jl/
   Resolving package versions...
    Updating `~/Documents/GitHub_PFE/RegularizedOptimization.jl/Project.toml`
  [5c8ed15e] ~ LinearOperators v2.10.0 ⇒ v2.10.0 `../LinearOperators.jl`
    Updating `~/Documents/GitHub_PFE/RegularizedOptimization.jl/Manifest.toml`
  [5c8ed15e] ~ LinearOperators v2.10.0 ⇒ v2.10.0 `../LinearOperators.jl`

(RegularizedOptimization) pkg> dev ../../GitHub/RegularizedProblems.jl
   Resolving package versions...
    Updating `~/Documents/GitHub_PFE/RegularizedOptimization.jl/Project.toml`
  [ea076b23] ~ RegularizedProblems v0.1.1 ⇒ v0.1.1 `../../GitHub/RegularizedProblems.jl`
    Updating `~/Documents/GitHub_PFE/RegularizedOptimization.jl/Manifest.toml`
  [ea076b23] ~ RegularizedProblems v0.1.1 ⇒ v0.1.1 `../../GitHub/RegularizedProblems.jl`

(RegularizedOptimization) pkg> 